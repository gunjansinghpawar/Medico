...
const Signup = () => {
  ...
  const { register } = useAuth(); // ✅ register(name, email, password)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // ✅ Correct call based on register signature
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="lg:pr-8">
                <div className="text-center lg:text-left mb-8">
                  ...
                  <h1 className="text-4xl font-bold mb-4">Join HealthBot AI</h1>
                ...
                <div className="bg-gradient-to-r from-blue-600 to-green-600 rounded-2xl p-6 border border-blue-100">
                  ...
                  <p className="mb-4">Get started with unlimited basic health consultations at no cost.</p>
              ...
              <div className="bg-background rounded-2xl shadow-xl border p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-3">
                    <label className="flex items-start space-x-3">
                      ...
                      <span className="text-sm text-foreground">
                        I agree to the{' '}
                        <Link href="/terms-and-condition" className="text-blue-600 hover:text-blue-700">
                          Terms of Service
                        </Link>{' '}
                        and{' '}
                  ...
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="w-full bg-gradient-to-r from-blue-600 to-green-600 text-white font-semibold py-3 px-6 rounded-xl hover:from-blue-700 hover:to-green-700 transition-all duration-300 flex items-center justify-center space-x-2 disabled:opacity-50"
                  >
