          ...
          <div className="max-w-md mx-auto">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-text-foreground">
                Sign in to your Medico AI account
              </p>
            </div>
            ...
            <div className="bg-background rounded-2xl shadow-xl border p-8">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full bg-gradient-to-r from-blue-600 to-green-600 text-white font-semibold py-3 px-6 rounded-xl hover:from-blue-700 hover:to-green-700 flex items-center justify-center disabled:opacity-70"
                >
            ...
            <div className="mt-8 text-center">
              <p className="text-sm text-foreground">
                Your data is protected with 256-bit encryption and HIPAA
                compliance.
              </p>
            </div>
          </div>
